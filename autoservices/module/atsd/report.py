...
def getAfterhourIndicatorData(user_email, agent_id, from_date, to_date):
    try:
        ...
        if isinstance(booked_list, list):
        ...
        if isinstance(scheduling_list, list):
            cnt_scheduling_afterhour = getCountOfAfterHour(
                scheduling_list,
                agent_obj.open_weekly_from,
                agent_obj.open_weekly_to,
                agent_obj.open_sat_from,
        ...
        if isinstance(l_week_incoming_list,list):
        ...
        if isinstance(c_week_incoming_list, list):
